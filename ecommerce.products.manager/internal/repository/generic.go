...
import (
	...
	internalErrors "ecommerce.products.manager/internal/errors"

	"github.com/uptrace/bun"
	"go.uber.org/zap"
)

func (r *productRepository) CreateGeneric(ctx context.Context, logger *zap.Logger, model any) error {
...
func (r *productRepository) GetGeneric(ctx context.Context, logger *zap.Logger, model any) error {
...
func (r *productRepository) UpdateGeneric(ctx context.Context, logger *zap.Logger, model any) (int64, error) {
...
func (r *productRepository) DeleteGeneric(ctx context.Context, logger *zap.Logger, model any) error {
...
func (r *productRepository) SearchGeneric(
	ctx context.Context,
	logger *zap.Logger,
	model any,
	page int,
